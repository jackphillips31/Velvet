...
// from which the log is called.
	...
	#define VL_CORE_BUG(...) ::Velvet::Log::GetCoreLogger()->debug("{:^30} {:>30}: {}",__FUNCTION__, LogLocationDebug::FormatFileAndLine(LogLocationDebug::ExtractFileName(__FILE__), __LINE__), LogLocationDebug::ToString(__VA_ARGS__))
	...
	#define VL_BUG(...) ::Velvet::Log::GetClientLogger()->debug("{:^30} {:>30}: {}",__FUNCTION__, LogLocationDebug::FormatFileAndLine(LogLocationDebug::ExtractFileName(__FILE__), __LINE__), LogLocationDebug::ToString(__VA_ARGS__))
	...
	#define VL_CORE_BUG(...) ::Velvet::Log::GetCoreLogger()->debug(__VA_ARGS__)
	...
	#define VL_BUG(...) ::Velvet::Log::GetClientLogger()->debug(__VA_ARGS__)
