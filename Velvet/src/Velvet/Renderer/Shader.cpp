...
namespace Velvet {
	...
	Velvet::Ref<Velvet::Shader> ShaderLibrary::Load(const std::string& filepath)
	{
	...
	Velvet::Ref<Velvet::Shader> ShaderLibrary::Load(const std::string& name, const std::string& filepath)
	{
		auto shader = Shader::Create(filepath);
		Add(name, shader);
		return shader;
	...
	Velvet::Ref<Velvet::Shader> ShaderLibrary::Get(const std::string& name)
	{
